...
export const ChooseUs = () => {
  return (
    <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-400 overflow-hidden rounded-[2rem] border border-pink-100 bg-[#fff1f5] shadow-[0_28px_80px_rgba(244,114,182,0.12)]">
        <div className="grid items-center gap-12 px-6 py-10 sm:px-10 md:px-12 lg:grid-cols-[0.92fr_1.08fr] lg:px-16 lg:py-16">
          <div className="max-w-xl">
            ...
            <h2 className="mt-6 max-w-lg text-4xl font-semibold tracking-tight text-gray-950 sm:text-5xl lg:text-[3.2rem] lg:leading-[1.05]">
              Few Reasons Why you Choose us?
            </h2>
            <p className="mt-6 max-w-xl text-[14px] text-gray-700">
            ...
            <ul className="mt-10 space-y-5">
              {reasons.map((reason) => (
                ...
                >
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#FAC4D2] text-[#ED3C6A]">
